...
3. Log in with your ChatGPT account and authorize LongerAgent.
...
The flow:
1. LongerAgent displays a URL and a code.
2. Open the URL on any device and enter the code.
3. Log in with your ChatGPT account.
4. LongerAgent polls for completion and stores the token.
