/**
 * Minimal .env file loader for ~/.fermi/.env.
 *
 ...
 * This ensures keys pasted during `fermi init` always win.
 */
...
function envFilePath(homeDir?: string): string {
  return join(homeDir ?? getFermiHomeDir(), ENV_FILE);
}

/**
 * Load ~/.fermi/.env into process.env (override mode).
...
/**
 * Write or update a key in ~/.fermi/.env.
