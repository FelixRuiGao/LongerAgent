/**
 * Minimal .env file loader for ~/.vigil/.env.
 *
 ...
 * This ensures keys pasted during `vigil init` always win.
 */
...
function envFilePath(homeDir?: string): string {
  return join(homeDir ?? getVigilHomeDir(), ENV_FILE);
}

/**
 * Load ~/.vigil/.env into process.env (override mode).
...
/**
 * Write or update a key in ~/.vigil/.env.
