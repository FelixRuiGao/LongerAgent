...
> **Platform:** macOS (Apple Silicon). Requires [Bun](https://bun.sh/) ≥ 1.1. **Safety:** Vigil does not sandbox shell commands or file edits. Run it in trusted environments and review what it does.
