  ...
  return (
    <div className="flex h-full items-center justify-center bg-pane">
      <div className="flex flex-col items-center text-center">
        <div className="text-[42px] font-semibold tracking-tight text-ink">
          Fermi
        </div>
        <p className="mt-3 max-w-[340px] text-[13px] leading-[1.65] text-ink-3">
        ...
        <button
          ...
          disabled={creating}
          className={cn(
            'mt-7 rounded-xl border border-line bg-pane-2 px-5 py-2.5 text-[13px] font-medium text-ink transition',
        ...
        <div className="mt-4 text-[11px] text-ink-4">
