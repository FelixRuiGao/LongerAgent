...
describe("managed provider credentials", () => {
  ...
  it("auto-registers managed provider models from LongerAgent env slots", () => {
    process.env["LONGERAGENT_GLM_CODE_API_KEY"] = "glm-code-secret";
  ...
  it("does not share managed credentials across endpoints", () => {
    process.env["LONGERAGENT_GLM_API_KEY"] = "glm-standard-secret";
